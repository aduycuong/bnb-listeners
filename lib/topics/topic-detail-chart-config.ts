...
export type TopicDetailChartPeriodPreset =
...
export type TopicDetailChartMetric =
  (typeof TOPIC_DETAIL_CHART_METRICS)[number];

export const TOPIC_DETAIL_CHART_METRIC_LABELS: Record<
...
export const TOPIC_DETAIL_DOCUMENTS_PAGE_SIZE = 30;
