...
import type { TermCardSparklinePoint } from "@/lib/terms/types";
import { cn } from "@/lib/utils";

type TermSparklineProps = {
  points: TermCardSparklinePoint[];
  className?: string;
};

export function TermSparkline({ points, className }: TermSparklineProps) {
  const width = 140;
  const height = 40;
  const padding = 2;
